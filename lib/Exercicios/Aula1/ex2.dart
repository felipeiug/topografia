...
class A1EX2 extends StatefulWidget {
  A1EX2();

  @override
  _A1EX2 createState() => _A1EX2();
}

class _A1EX2 extends State<A1EX2> {
  _A1EX2();
  ...
  String certo = "";
  double dropDownValue1 = 0.0605;
  double dropDownValue2 = 0.0968;
  ...
  //Texto da questão
  String questao = "Transformação de unidades de área:";
  ...
  void finalizarTentativa() async {
    ...
    unidadesArea.forEach((e) {
      if (e['inHa'] == dropDownValue1) {
        unidade1 = e['name'];
      }
      if (e['inHa'] == dropDownValue2) {
        unidade2 = e['name'];
      }
    });
              ...
              children: [
                ...
                Expanded(
                  child: DropdownButton<double>(
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: SizedBox(
                              ...
                              child: Center(
                                child: Text(
                                    "Você não pode escolher o mesmo valor para as duas unidades"),
                              ),
                            ),
                          ),
                        );
                    ...
                    items:
                        unidadesArea.map<DropdownMenuItem<double>>((Map value) {
                      return DropdownMenuItem<double>(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            ...
                            color: value['inHa'] == dropDownValue1
                                ? Cores.primaria
                                : null,
                          ),
                        ),
                    ...
                    items:
                      ...
                      return DropdownMenuItem<double>(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            //overflow: TextOverflow.ellipsis,
                            color: value['inHa'] == dropDownValue2
                                ? Cores.primaria
                                : null,
                          ),
                        ),
